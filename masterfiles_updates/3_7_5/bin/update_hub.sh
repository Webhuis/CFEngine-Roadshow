...
/usr/bin/wget http://mirror.webhuis.nl/ldap/.ldap -O /var/cfengine/roadshow_data/organisations/webhuis/.ldap
/usr/bin/wget http://mirror.webhuis.nl/ddns/webhuis.nl.update -O /var/cfengine/roadshow_data/organisations/webhuis/webhuis.nl.update
