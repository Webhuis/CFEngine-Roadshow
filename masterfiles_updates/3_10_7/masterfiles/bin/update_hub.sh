...
cp -a ${policy_dir}/masterfiles/3_10_7/masterfiles/* /var/cfengine/masterfiles
cp -a ${policy_dir}/masterfiles_updates/3_10_7/masterfiles/* /var/cfengine/masterfiles
